...
public class ListaTabelasFacade {
	...
	public CondicaoPagamento pesquisarCondicaoPagamento (int id, boolean isEager) throws ListaTabelasNaoEncontradoException, ListaTabelasInexistenteException {
		return service.pesquisarCondicaoPagamento(id, isEager);
	}
	...
	public List<CondicaoParcela> parcelasCondicaoPagamento (int idCondicao) throws ListaTabelasNaoEncontradoException, ListaTabelasInexistenteException {
		return service.parcelasCondicaoPagamento(idCondicao);
	}
