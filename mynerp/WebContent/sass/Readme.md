...
folder are mapped to the application's root namespace, 'Mynerp'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Mynerp' in the same way
as `"Mynerp/sass/src"`.
