Ext.define('Mynerp.view.cadastro.ClienteForm', {
   		...
   		'Mynerp.util.Glyphs'
			...
			items: [
				...
				items: [
					   ...
					   xtype: 'container',
					   layout: 'hbox',
					   defaultFocus: 'pfPj', // acho que não funcionou
					   combineErrors: true,
					   defaults: {
						   flex: 1,
						   xtype: 'textfield',
