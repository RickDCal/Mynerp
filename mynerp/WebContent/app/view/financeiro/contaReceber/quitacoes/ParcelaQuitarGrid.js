Ext.define('Mynerp.view.financeiro.contaReceber.quitacoes.ParcelaQuitarGrid', {
    ...
    reference: 'parcelaQuitarGridCr',

    bind : '{parcelasquitarcr}',    
    ...
    dockedItems: [
        
        {
            ...
            defaults: { 
                xtype: 'mysearchfield',
                storeName: 'parcela-quitar-grid-cr'//'parcelasquitar' // vai pegar em todos mas nem todos precisam
            }, 
