Ext.define('Mynerp.view.financeiro.contaReceber.quitacoes.ParcelaQuitarModel', {
    extend: 'Ext.app.ViewModel',

    alias: 'viewmodel.parcelasquitarcr',
