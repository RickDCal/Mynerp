...
<body>
	...
	<div id="conteudo">
		<br>
		<h1>
			<a>Cadastro de Fornecedores</a>
		</h1>
		<div>
			<form name="filtroRelCadClientes" id="filtroRelCadClientes"
				method="post" action="relatCadFornecedores.jsp"
				onsubmit="return validarFiltrosCadClientes()">
				<div class="alerta" id="alerta1"></div>
				<br> <label class="tamData"><a id="alabelperiodo">Data de Cadastro</a> <input type="date" class="data" name="dataInicio"
