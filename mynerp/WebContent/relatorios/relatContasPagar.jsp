...
<%
	...
	String relatorio = "Relatório: Cadastro de Contas a Pagar";
	...
	String codfornecedor = request.getParameter("fornecedor");
	...
	if (codfornecedor!= null && !codfornecedor.isEmpty()) {			
			Integer idfornecedor = Integer.parseInt(codfornecedor);	
			forn = (Fornecedor)pessoaFacade.pesquisar(PessoaEnum.FORNECEDOR, idfornecedor);
			nomeFornecedor = "|	Fornecedor: " + forn.getNome();
	...
	List<Parcela> listRelCtaPagar = contaFacade.pesquisarParcelas(ContaEnum.PAGAR, emissaoInicio, emissaoFim, vencimentoInicio, vencimentoFim, quitacaoInicio, quitacaoFim, forn, idPagamento, null, null, order);//pesquisarCP();
	Iterator<Parcela> itListRelCtaPagar = null;
			
			itListRelCtaPagar = listRelCtaPagar.iterator();
	...
	<div id = "conteudo">
		<div class="noprint">	 	
		 ...
		 <div id="dadosRelatorio">
		 	...
		 	<br>
		 	<b><%=relatorio + " " + nomeFornecedor + " " + periodoEmissao + " " + periodoVencimento + " " + periodoQuitacao + " " + pagamento %></b>
		 	<br>
		 	<table  class="relat" align="center" width = "1180px">
				...
				<th class="grid tam12">Fornecedor</th>
				...
				double totalPagar = 0;
		 			...
		 			rodape = "<td colspan = \"10\">" + session.getAttribute("dadosRodape") + "</td>";
						...
						while (itListRelCtaPagar.hasNext()) {							
							
						
							
							Parcela parcela = (Parcela)itListRelCtaPagar.next();
							...
							if (parcela.getDataQuitacao() != null) {
								...
								totalPago = totalPago + parcela.getValor();
							} else {
								totalPagar = totalPagar + parcela.getValor();
							}
				...
				<% 
		 		...
		 		<tr class="relat"><td colspan=8>
					...
					+ "&nbsp;&nbsp;&nbsp;&nbsp; Vlr. Pago: R$ " + String.format("%.2f",totalPago) + "&nbsp;&nbsp;&nbsp;&nbsp;Vlr. Pagar: R$ " + String.format("%.2f",totalPagar) 
